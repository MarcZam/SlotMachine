...
def get_slot_machine_spin(rows, cols, symbols):
    ...
    for _ in range(cols):
        column = []
        current_symbols = all_symbols[:] # semicolon for a copy not a reference to the variable
        for _ in range(rows):
...
def turn_slot(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"Not enough funds, your current balance is ${balance}")
        else:
            break
